...
from bix.data.twitter.base.utils import load_model_mat, load_training_sentiment_data_small, load_pickle, load_csv, \
...
if __name__ == '__main__':
    ...
    print(model.summary())
    # fit the model
    model.fit([x_train], y_train, epochs=100, verbose=1, batch_size=8000, validation_split=0.1)
