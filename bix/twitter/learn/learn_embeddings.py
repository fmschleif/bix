...
from bix.twitter.base.utils import save_model_mat, load_training_sentiment_data_small, load_training_sentiment_data
...
from bix.twitter import EmbeddingWord
